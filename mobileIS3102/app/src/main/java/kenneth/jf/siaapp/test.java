                    ...
                    public void run() {
                        try {
                            ...
                            if ( !v ){
                                ...
                                final SweetAlertDialog xx = new SweetAlertDialog(getContext(), SweetAlertDialog.SUCCESS_TYPE);
                                xx.setTitleText("Congratulations!");
                                xx.setContentText("Ticket verified!");
                                xx.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    @Override
                                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                                        System.out.println("before on click");
                                        Intent intent = new Intent(getActivity(), dashboard.class);
                                        intent.putExtra("key2", "purchasedTix");
                                        xx.dismissWithAnimation();
